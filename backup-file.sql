...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$320000$iXUdD5BfihRlUilcjKM06D$/GUO+8KVfNAYrYs8Q7THkBzsL6YyhsmlPgpy71Qh6yI=','2022-08-24 11:14:50.030656',1,'user','','','',1,1,'2022-07-18 08:27:21.778415');
...
CREATE TABLE `global_controller_auction` (
  ...
  KEY `global_controller_auction_inventory_id_af1efa92` (`inventory_id`),
  CONSTRAINT `global_controller_au_bid_id_8d48c5e4_fk_global_co` FOREIGN KEY (`bid_id`) REFERENCES `global_controller_bid` (`id`),
  CONSTRAINT `global_controller_au_inventory_id_af1efa92_fk_global_co` FOREIGN KEY (`inventory_id`) REFERENCES `global_controller_inventory` (`id`),
...
INSERT INTO `global_controller_auction` VALUES (1,'2022-08-23 14:00:00.000000','2022-08-18 15:00:00.000000',1,5000,1,1,0,NULL),(3,'2022-08-23 15:00:00.000000','2022-08-18 16:00:00.000000',10,1000,1,9,0,NULL),(5,'2022-08-22 16:00:00.000000','2022-08-22 06:30:12.000000',15,40000,1,10,0,NULL),(7,'2022-08-22 07:20:00.000000','2022-08-24 07:20:00.000000',10,10000,6,7,0,NULL),(9,'2022-08-24 09:00:00.000000','2022-08-25 09:00:00.000000',NULL,30000,1,NULL,1,NULL),(10,'2022-08-24 10:30:00.000000','2023-09-25 10:30:00.000000',NULL,45621,1,NULL,1,NULL),(11,'2022-08-24 03:00:00.000000','2022-08-24 23:59:00.000000',1,10000,1,10,0,1),(12,'2022-08-24 02:14:00.000000','2023-09-25 14:14:00.000000',5,12000,1,1,0,NULL);
...
INSERT INTO `global_controller_bid` VALUES (1,10000,1);
...
INSERT INTO `global_controller_category` VALUES (1,'Monitor'),(2,'Mouse'),(3,'Keyboard'),(4,'17');
...
INSERT INTO `global_controller_customer` VALUES (1,'irshad','dhaka','123','101',63600,2,'1705109@ugrad.cse.buet.ac.bd'),(5,'Abrar Shahriare','Dhaka','6137813691123','102',20400,2,'nasif.car@gmail.com');
...
INSERT INTO `global_controller_hub` VALUES (1,'rajshahi'),(2,'dhaka'),(3,'1211');
...
INSERT INTO `global_controller_hubman` VALUES (1,'nazmul','mohammadpur','234435456','301',2);
...
INSERT INTO `global_controller_inventory` VALUES (1,74,1,1,'vg249q-1-500x500.jpg'),(2,52,2,1,'g502-hero-1-500x500.jpg'),(3,41,3,2,'g24f-23-8-2-500x500.jpg'),(4,65,4,2,'logitech-g-pro.jpg'),(7,38,8,6,'op-720-01-500x500.jpg'),(8,8,9,6,'bangla_dictionary.png'),(9,150,10,1,'logitech_m910.jpg'),(10,50,11,1,'keychron_c1.jpg');
...
INSERT INTO `global_controller_order` VALUES (1,'qqwwee',1,1,2,1,1,3),(4,'qqwwee',1,1,4,1,1,2),(5,'qqwwee',4,1,4,2,1,3),(6,'qqwwee',3,1,5,1,1,3),(7,'qqwwee',2,1,5,2,1,2),(8,'qqwwee',1,1,6,1,1,1),(9,'qqwwee',1,1,6,1,1,1),(10,'qqwwee',1,1,6,2,1,2),(11,'qqwwee',1,1,7,1,1,1),(12,'qqwwee',1,1,7,1,1,1),(13,'qqwwee',1,1,7,2,1,1),(14,'qqwwee',1,1,8,2,1,1),(15,'qqwwee',1,1,9,2,1,2),(16,'LHqYCZ',1,1,10,2,1,1),(17,'LHqYCZ',1,1,10,2,1,1),(18,'FVRWiM',1,1,11,2,1,1),(19,'FVRWiM',1,1,11,2,1,1),(20,'ewBbcE',1,1,12,2,1,1),(21,'zBZKYG',1,1,13,2,1,1),(22,'VyufiF',1,1,14,2,1,1),(23,'WmSslA',1,1,15,2,1,3),(24,'oIEHGS',1,1,16,3,2,1),(25,'VtDCaW',1,1,17,3,2,1),(26,'oIEHGS',1,1,16,3,2,1),(27,'VtDCaW',1,1,17,3,2,1),(28,'oIEHGS',1,1,16,4,2,3),(29,'VtDCaW',1,1,17,4,2,1),(30,'oIEHGS',1,1,16,4,2,1),(31,'VtDCaW',1,1,17,4,2,3),(32,'XmWviA',3,1,18,1,1,1),(33,'lSTfJb',3,1,19,1,1,1),(34,'XmWviA',1,1,18,2,1,1),(35,'lSTfJb',1,1,19,2,1,1),(36,'yNajvy',2,1,20,3,2,3),(37,'UKIWCM',2,1,21,3,2,3),(38,'fLbIus',1,1,22,1,1,1),(39,'cjBICV',1,1,23,1,1,1),(40,'fLbIus',2,1,22,3,2,1),(41,'cjBICV',2,1,23,3,2,1),(42,'mPkDCA',1,1,24,1,1,1),(43,'DaBFoF',1,1,25,1,1,1),(44,'ULQKAJ',5,1,26,1,1,2),(45,'CAUqJp',1,1,27,1,1,1),(46,'MoNyJI',4,1,28,2,1,1),(47,'pdZFWE',3,1,29,8,6,1),(48,'qAqArK',4,1,30,8,6,1),(49,'kxnjFI',1,1,31,1,1,1),(50,'kxnjFI',1,1,31,2,1,1),(51,'kxnjFI',1,1,31,3,2,1),(52,'kxnjFI',1,1,31,4,2,1),(53,'kxnjFI',1,1,31,8,6,1),(54,'kxnjFI',1,1,31,9,6,1),(55,'NYfGiH',1,1,32,1,1,1),(56,'NYfGiH',1,1,32,2,1,1),(57,'WexWJq',1,1,33,2,1,1),(58,'WexWJq',1,1,33,3,2,1),(59,'HBbcdd',1,1,34,3,2,1),(60,'PaDewG',1,1,35,3,2,1),(61,'oXQAey',1,1,36,3,2,1),(62,'IpGJse',2,1,37,8,6,1),(63,'cKAlYF',2,1,38,8,6,1),(64,'FuCDik',1,1,39,3,2,1),(65,'FuCDik',1,1,39,4,2,1),(66,'HJVeWp',1,1,40,3,2,1),(67,'HJVeWp',1,1,40,2,1,1),(68,'RckoXj',1,1,41,1,1,2),(69,'cSwPOk',1,1,42,1,1,1),(70,'cSwPOk',2,1,42,2,1,2),(71,'fwNKGB',1,1,43,2,1,1),(72,'d9ftZN',1,1,44,2,1,1),(73,'d9ftZN',1,1,44,3,2,1),(74,'lddY99',1,1,45,9,6,1);
...
INSERT INTO `global_controller_order_status` VALUES (1,'In Shop'),(2,'Picked Up'),(3,'Delivered'),(4,'In HubCustomer'),(5,'In HubSeller');
...
INSERT INTO `global_controller_packageitem` VALUES (1,15,9,2),(2,15,9,9),(3,20,10,2);
...
INSERT INTO `global_controller_seller` VALUES (1,'Nasif','New Market, Rajshahi','123123','201','abc','ABC Bank','91239108209',205400,1,'23.732614, 90.384543'),(2,'Abrar','Dhanmondi, Dhaka','123456789','402','Abrar Electronics','UCBL','98765432',240400,2,'23.738853824452487, 90.38558968705205'),(3,'Shibly','Jigatola, Dhaka','2345678','202','Shibly Computers','NRBC Bank','123456789',0,2,''),(4,'Shibly','Jigatola, Dhaka','123456789','','Shibly Computers','','',0,2,''),(6,'Shuvo','Lalbagh, Dhaka','6137813691123','203','Spark Gear','NRBC Bank','54923186153',5330,2,'23.72008094330496, 90.38939237594604'),(7,'Tushar','Lalmatia, Dhaka','6137813691123','204','Bliss Electronics','UCBL','486321',0,2,'23.75675293038741, 90.37490844726564'),(8,'Sajon Islam','Lalmatia, Dhaka','123156321','110','Sajon Computers','UCBL','123456',0,2,'23.757381390787604, 90.37559509277345');
...
INSERT INTO `global_controller_user` VALUES ('','',4),('101','irshad',1),('102','abrar',1),('110','sajon',4),('201','nasif',4),('202','shibly',4),('203','shuvo',4),('204','tushar',4),('210','tushar',4),('301','nazmul',2),('401','kamal',3),('402','abrar',4),('irshad','irshad',1);
...
-- Dump completed on 2022-08-24 17:45:53
