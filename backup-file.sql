...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$320000$iXUdD5BfihRlUilcjKM06D$/GUO+8KVfNAYrYs8Q7THkBzsL6YyhsmlPgpy71Qh6yI=','2022-08-07 15:25:18.113424',1,'user','','','',1,1,'2022-07-18 08:27:21.778415');
...
INSERT INTO `global_controller_customer` VALUES (1,'irshad','dhaka','123','123',30000,2),(2,'<script>alert(\"h\")</script>','Uttara, Dhaka','6137813691123','21379183789',0,2),(3,'<script>alert(\"h\")</script>','Uttara, Dhaka','6137813691123','21379183789',0,2),(4,'<script>alert(\"hello\")</script>','Uttara, Dhaka','6137813691123','01706363005',0,2);
...
INSERT INTO `global_controller_deliveryman` VALUES (1,'kamal','Dhaka','Pickup Man','126386172368','21379183789','DK 22001');
...
INSERT INTO `global_controller_inventory` VALUES (1,11,1,1),(2,7,2,1);
...
INSERT INTO `global_controller_order` VALUES (1,'qqwwee',1,1,2,1,1,1),(4,'qqwwee',1,1,4,1,1,1),(5,'qqwwee',4,1,4,2,1,1),(6,'qqwwee',3,1,5,1,1,1),(7,'qqwwee',2,1,5,2,1,1);
...
INSERT INTO `global_controller_order_set` VALUES (1,'2022-07-27',1,3),(2,'2022-07-27',1,4),(3,'2022-07-27',1,5),(4,'2022-07-27',1,6),(5,'2022-07-28',1,7);
...
INSERT INTO `global_controller_seller` VALUES (1,'Nasif','New Market, Rajshahi','123123','01706363005','abc','ABC Bank','91239108209',0,1);
...
INSERT INTO `global_controller_transaction` VALUES (1,'buy',65300),(2,'buy',65300),(3,'buy',65300),(4,'buy',65300),(5,'buy',65300),(6,'buy',65300),(7,'buy',143900);
...
INSERT INTO `global_controller_user` VALUES ('<script>alert(\"hello\")</script>','irshad',1),('irshad','irshad',1),('kamal','kamal',3),('Nasif','nasif',4);
...
-- Dump completed on 2022-08-07 22:09:49
